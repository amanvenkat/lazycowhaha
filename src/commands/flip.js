        ...
        try {
            ...
            if (content.includes('heads')) {
                ...
                if (coinFlip === heads) {
                    ...
                    return message.channel.send('It was heads! You have been awarded 1000 coins!').catch(() => {});
                } else {
                ...
                if (coinFlip === tails) {
                    ...
                    return message.channel.send('It was tails! You have been awarded 1000 coins!').catch(() => {});
                } else {
