...
module.exports = {
    ...
    async execute(memer, message) {
        ...
        if (donor === false) {
            ...
            return message.channel.send('This command is for donors only. You can find more information on https://twitter.com/4manAU if you are interested.').catch(() => {});
        }
        ...
        const multiplier = randomNum(1, 100); // lets say everyone donated $100
