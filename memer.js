...
}.then(function() => console.log('connected db'));
    ...
    if (hasCooldown) {
        ...
        const e = new discord.MessageEmbed()
            ...
            .setDescription(`${(cooldown.message==='')?'Try again in':cooldown.message} ${(timeLeft > 60 ? `**${util.parseTime(timeLeft)}**` : `**${timeLeft.toFixed()} seconds**`)}\n\n` +
                ...
                'While you wait, go check out our [Twitter](https://twitter.com/4manAU), [Youtube](https://www.youtube.com/channel/UC5DqQh9__HKLd_HpDAXxsVw), and [Discord Server](https://discord.gg/aj3hz97m5U)')
            .setColor('#3f51b5');
